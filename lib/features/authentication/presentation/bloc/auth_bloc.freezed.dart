...
mixin _$AuthEvent {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(String email, String password, String? name)? login,
...
class _$LoginImpl implements _Login {
  const _$LoginImpl({required this.email, required this.password, this.name});
  ...
  @override
  String toString() {
    return 'AuthEvent.login(email: $email, password: $password, name: $name)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return login?.call(email, password, name);
  }
